...
nForgetPoints = 30;  % T0 - número de dados descartados durante o período de washout da ESN no treinamento
...
qCrossover = 0.2;   % taxa de crossover quântico
showEv = 1;
gap = numClassic;          
seed = rng;
xanterior = [];
...
limSup = [150; 0.99; 1; 1; 1; 1];   % limites superiores das variáveis
