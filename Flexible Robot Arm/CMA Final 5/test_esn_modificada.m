function [outputSequence,finalTotalState] = test_esn_modificada(inputSequence, esn, nForgetPoints, varargin)
...
finalTotalState = [stateCollection(end,:) outputSequence(end,:)]';
