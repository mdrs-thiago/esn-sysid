...
numPulses = 10;     % população quântica
...
limSup = [300; 0.99; 1; 1; 1; 1];   % limites superiores das variáveis
...
%   mse_test_error_y2_SRG (exp) = feval('MSE',yTestePrevisto(:,2), yTeste(:,2));
  ...
  RRSE_test_error_y1_SRG  (exp) = feval('RRSE',yTestePrevisto(:,1), yTeste(:,1));
  RRSE_test_error_y2_SRG  (exp) = feval('RRSE',yTestePrevisto(:,2), yTeste(:,2));
...
%   mse_test_error_y2_random (exp)= feval('MSE',yTestePrevisto(:,2), yTeste(:,2));
  ...
  RRSE_test_error_y1_random (exp) = feval('RRSE',yTestePrevisto(:,1), yTeste(:,1));
  RRSE_test_error_y2_random (exp)= feval('RRSE',yTestePrevisto(:,2), yTeste(:,2));
