...
for exp =1:numExp
  for i=1:numRedes     
     ...
     reservatorio = 100;  % número de neurônios no reservatório

     raio = 0.3;          % raio espectral
 
     ScalWin = 0.6;       % constante de multiplicação da matriz Win
 
     ScalWback = 0.0001;     % constante de multiplicação da matriz Wback
 
     vazamento = 0.5;     % leaky rate dos neurônios leaky integrator
