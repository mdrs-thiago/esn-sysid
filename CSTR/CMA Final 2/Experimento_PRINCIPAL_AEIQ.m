...
nForgetPoints = 100; % T0 - número de dados descartados durante o washout

numRedes = 5;

metricaErro ='RMSE';

num_var = 6; % número de variáveis a serem otimizadas
...
numPulses= 1;      %indivíduos quânticos
numClassic= 3;
genToWidth=5;
generations=1;
crossover=0.05;
...
[sol{exp}, classic,  evobestRRSEness{exp}, trace] = aeiq_br_real(num_var, numPulses, numClassic, ...
