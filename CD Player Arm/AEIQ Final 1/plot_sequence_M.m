function plot_sequence_M(teacherSequence, predictedSequence1,predictedSequence2,predictedSequence3,predictedSequence4,predictedSequence5, nPoints, caption)
...
for iPlot = 1 : nDimensions
    ...
    plot(predictedSequence1(1:nPoints, iPlot),) ;
    plot(predictedSequence2(1:nPoints, iPlot)) ;
    plot(predictedSequence3(1:nPoints, iPlot)) ;
    plot(predictedSequence4(1:nPoints, iPlot)) ;
end
