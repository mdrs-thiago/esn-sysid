...
nForgetPoints = 10;  % T0 - número de dados descartados durante o período de washout da ESN no treinamento
...
numPulses = 15;     % população quântica
numClassic = 75;   % população clássica
genToWidth = 5;     % intervalo de gerações para atualização da população quântica
generations = 150;  % número de gerações
crossover = 0.85;    % taxa de crossover clássico real
qCrossover = 0.7;   % taxa de crossover quântico
showEv = 1;
gap = numClassic;          
seed = rng;
xanterior = [];
...
limInf = [15; 0.10; 0.0001; 0; 0.1;0.1]; % limites inferiores das variáveis
 
limSup = [75; 0.99; 1; 1; 1; 1];   % limites superiores das variáveis
...
numClassic2 = 60;    % população clássica
genToWidth2 = 5;    % intervalo de gerações para atualização da população quântica
generations2 = 500;   % número de gerações
crossover2 = 0.8;  % taxa de crossover clássico real
qCrossover2 = 0.6; % taxa de crossover quântico
gap2 = numClassic2;    
