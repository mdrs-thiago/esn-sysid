...
for exp =1:numExp
  for i=1:numRedes     
     ...
     reservatorio = 40;  % número de neurônios no reservatório

     raio = 0.7;          % raio espectral
 
     ScalWin = 0.1;       % constante de multiplicação da matriz Win
 
     ScalWback = 0.2;     % constante de multiplicação da matriz Wback
 
     vazamento = 0.9;     % leaky rate dos neurônios leaky integrator

     conectividade = 0.2; % percentual de conectividade dos neurônios do reservatório
