...
crossover = 0.45;    % taxa de crossover clássico real
qCrossover = 0.75;   % taxa de crossover quântico
showEv = 1;
gap = numClassic;          
seed = rng;
xanterior = [];
...
limSup = [250; 0.99; 1; 1; 1; 1];   % limites superiores das variáveis
...
numClassic2 = 75;    % população clássica
genToWidth2 = 5;    % intervalo de gerações para atualização da população quântica
generations2 = 150;   % número de gerações
crossover2 = 0.45;  % taxa de crossover clássico real
qCrossover2 = 0.75; % taxa de crossover quântico
gap2 = numClassic2;    
