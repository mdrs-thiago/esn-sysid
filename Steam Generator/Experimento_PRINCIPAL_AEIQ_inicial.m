...
numRedes = 1;         % número de redes avaliadas por cada indivíduo na etapa 1 de otimização de parâmetros da ESN
...
numClassic = 2;      % população clássica
...
limSup = [1000; 0.99; 1; 1; 1; 1];   % limites superiores das variáveis
