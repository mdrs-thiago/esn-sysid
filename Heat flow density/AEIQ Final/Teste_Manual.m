...
for exp =1:numExp
  for i=1:numRedes     
     ...
     raio = 0.8;          % raio espectral
 
     ScalWin = 0.7;       % constante de multiplicação da matriz Win
 
     ScalWback = 0.01;     % constante de multiplicação da matriz Wback
 
     vazamento = 0.6;     % leaky rate dos neurônios leaky integrator

     conectividade = 0.8; % percentual de conectividade dos neurônios do reservatório
