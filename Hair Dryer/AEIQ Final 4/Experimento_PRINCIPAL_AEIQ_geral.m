...
nForgetPoints = 50;  % T0 - número de dados descartados durante o período de washout da ESN no treinamento
...
numPulses = 20;     % população quântica
numClassic = 60;   % população clássica
genToWidth = 5;     % intervalo de gerações para atualização da população quântica
generations = 50;  % número de gerações
crossover = 0.9;    % taxa de crossover clássico real
...
limInf = [20; 0.10; 0.0001; 0; 0.1;0.1]; % limites inferiores das variáveis
 
limSup = [100; 0.99; 1; 1; 1; 1];   % limites superiores das variáveis
...
numPulses2 = 25;     % população quântica
...
crossover2 = 0.85;  % taxa de crossover clássico real
qCrossover2 = 0.7; % taxa de crossover quântico
gap2 = numClassic2;    
