...
numExp = 1;           % número de experimentos 
...
limSup = [400; 0.99; 1; 1; 1; 1];   % limites superiores das variáveis
...
% numClassic2 = 2;    % população clássica
...
% 
%   limInf2 = (-1.*ones(1,num_var2))'; 
%   limSup2 = (1.*ones(1,num_var2))';
%  
