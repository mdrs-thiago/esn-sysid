...
numClassic = 25;   % população clássica
...
limInf = [75; 0.10; 0.0001; 0; 0.1;0.1]; % limites inferiores das variáveis
 
limSup = [275; 0.99; 1; 1; 1; 1];   % limites superiores das variáveis
